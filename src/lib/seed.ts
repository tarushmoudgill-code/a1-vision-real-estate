...
export async function runSeed() {
  ...
  // Agents — one of each role: Govinder (Principal), Ravi (Regional Manager), Tarush (Programmer/Designer).
  const agentsData = [
  ...
  const tarushUserId = agentUsers[2].id;
